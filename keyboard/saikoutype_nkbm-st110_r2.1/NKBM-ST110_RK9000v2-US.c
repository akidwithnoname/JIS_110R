...
// LAYER 0: JP ----------------------------------------------------------------------------------------------------------\
            ...
            | `---'   `---------------' `---------------' `---------------' `-----------'       o   o   o   |            \
            | ,-----------------------------------------------------------. ,-----------. ,---------------. |            \
            | | ~ | 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9 | 0 | - | = | BSPACE| |INS|HOM|PGU| |NUM| / | * | - | |            \
            | |-----------------------------------------------------------| |-----------| |---------------| |            \
            ...
            | |-----------------------------------------------------------| ,-----------. |------------ / | |            \
            | |CTRL| OS |ALT |         SPACE          |ALT | OS | FN |CTRL| |LEF|DOW|RIG| |   0   | . |HEX| |            \
            | `-----------------------------------------------------------' `-----------' `---------------' |            \
            `----------------------------------------------------------------------------------------------'             \
                                                                                                                         /
  [0] = ACTIONMAP_NKBMST110(                                                                                             \
    ESC,       F1,  F2,  F3,  F4,    F5,  F6,  F7,  F8,    F9,  F10, F11, F12,    PSCR,SCLK,PAUS,                        \
                                                                                                                         \
    ZKHK,1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL ,NO,  BSPC,   INS, HOME,PGUP,   NLCK,PSLS,PAST,PMNS, \
    TAB,   Q,   W,   E,   R,   T,   Y,   U,   I,   O,   P,   LBRC,RBRC,           DEL, END, PGDN,   P7,  P8,  P9,        \
    FCAP,   A,   S,   D,   F,   G,   H,   J,   K,   L,   SCLN,QUOT,BSLS,   ENT,                     P4,  P5,  P6,  PPLS, \
    LSFT,NO,  Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH,NO,       RSFT,        UP,          P1,  P2,  P3,        \
    LCTL,LGUI,LALT,NO,         NO,  SPC, NO,          NO,  RALT,RGUI,FNNM,RCTL,   LEFT,DOWN,RGHT,   P0,       PDOT,SHEX),\
...
// LAYER 2: Game/Type ---------------------------------------------------------------------------------------------------\
  ...
  [2] = ACTIONMAP_NKBMST110(                                                                                             \
    ...
    FCAP,   TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,  TRNS,                     TRNS,TRNS,TRNS,TRNS, \
    TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,     TRNS,        TRNS,        TRNS,TRNS,TRNS,      \
    TRNS,TRNS,TRNS,TRNS,       NO,  SPC, NO,          TRNS,TRNS,TRNS,TRNS,TRNS,   TRNS,TRNS,TRNS,   TRNS,     TRNS,TRNS),\
...
// LAYER 7: FN 2 --------------------------------------------------------------------------------------------------------\
            ,-----------------------------------------------------------------------------------------------.            \
            | ,---.   ,---------------. ,---------------. ,---------------. ,-----------.                   |            \
            | |CLR|   |WWW|MAL|PRV|NXT| |PLY|STP|RWD|FWD| |   |   |   |   | |WAK|   |SLP|                   |            \
            | `---'   `---------------' `---------------' `---------------' `-----------'       o   o   o   |            \
            | ,-----------------------------------------------------------. ,-----------. ,---------------. |            \
  ...
  [7] = ACTIONMAP_NKBMST110(                                                                                             \
    CLAL,      WHOM,MAIL,MPRV,MNXT,  MPLY,MUTE,VOLD,VOLU,  TRNS,TRNS,TRNS,TRNS,   WAKE,TRNS,SLEP,                        \
                                                                                                                         \
