...
uint8_t lookup(uint8_t index) {
    ...
    static const uint8_t lookup[94] = {
        ...
        KC_LBRC, /* emd shift */ KC_A, KC_B, KC_C, KC_D, KC_E, KC_F, KC_G, KC_H, KC_I, KC_J, KC_K, KC_L, KC_M, KC_N, KC_O, KC_P, KC_Q, KC_R, KC_S, KC_T, KC_U, KC_V, KC_W, KC_X, KC_Y, KC_Z, /* shift */ KC_RBRC, KC_JYEN, KC_BSLS, KC_EQL
        };
...
// LAYER 6: FN ----------------------------------------------------------------------------------------------------------\
  ...
  [6] = ACTIONMAP_NKBMST110(                                                                                             \
    CLAL,      TRNS,TRNS,TRNS,TRNS,  TRNS,TRNS,TRNS,TRNS,  TRNS,TRNS,TRNS,TRNS,   WAKE,DTOS,SLEP,                        \
                                                                                                                         \
    CLAL,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,   MPLY,MNXT,VOLU,   CALC,TRNS,TRNS,MSKY, \
    TRNS,  TRNS,TRNS,TRNS,KPRS,TRNS,TRNS,TRNS,TRNS,DTOS,TRNS,TRNS,TRNS,           MUTE,MPRV,VOLD,   TRNS,TRNS,TRNS,      \
    TRNS,   TRNS,STR1,TRNS,TRNS,TRNS,TRNS,TRNS,KPPR,TRNS,TRNS,TRNS,TRNS,  TRNS,                     TRNS,TRNS,TRNS,TRNS, \
    TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,INFO,TRNS,     TRNS,        TRNS,        TRNS,TRNS,TRNS,      \
...
// LAYER 7: FN 2 --------------------------------------------------------------------------------------------------------\
            ...
            | |-----------------------------------------------------------| |-----------| |---------------| |            \
            | |     |HOM|UP |END|PGU|WHU|   |   |   |   |   |   |   |     | |LMN|LDN|LDH| |LCL|MSU|RCL|   | |            \
            | |------------------------------------------------------     | `-----------' |------------SCU| |            \
  ...
  [7] = ACTIONMAP_NKBMST110(                                                                                             \
    CLAL,      VOLD,VOLU,MPRV,MNXT,  MPLY,MSTP,MRWD,MFFD,  TRNS,TRNS,TRNS,TRNS,   WAKE,TRNS,SLEP,                        \
                                                                                                                         \
    CLAL,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,   LED1,LEDU,LDUH,   TRNS,WH_L,WH_R,BTN3, \
    TRNS,  HOME,UP,  END, PGUP,WH_U,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,           LED0,LEDD,LDDH,   BTN1,MS_U,BTN2,      \
    TRNS,   LEFT,DOWN,RGHT,PGDN,WH_D,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,  TRNS,                     MS_L,MS_D,MS_R,WH_U, \
    TRNS,TRNS,BSPC,DEL, INS, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,     TRNS,        TRNS,        NO,  NO,  NO,        \
